...
public class UserDataProducer {
    public static void main(String[] args) throws ExecutionException, InterruptedException, IOException {
        ...
        properties.setProperty(BOOTSTRAP_SERVERS_CONFIG, "127.0.0.1:9094");
        properties.setProperty(KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class.getName());
        properties.setProperty(VALUE_SERIALIZER_CLASS_CONFIG, StringSerializer.class.getName());
        // producer acks
        properties.setProperty(ACKS_CONFIG, "all"); // strongest producing guarantee
        ...
        // since the result of producer.send() is future, we block it with .get() since it will not move on until the result is back

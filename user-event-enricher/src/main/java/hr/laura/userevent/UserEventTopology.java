...
// run Kafka Streams (topology) before running the producer
@Component
public class UserEventTopology {
    public static void main(String[] args) {
        ...
        // we want to enrich that stream (user purchases with user info)
        KStream<String, String> userPurchasesEnrichedJoin =
                userPurchases.join(usersGlobalTable, // .join indicates inner join - userPurchase, userInfo will not be null
